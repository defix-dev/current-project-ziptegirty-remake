...
import org.defix.weather.api.facade.WeatherControllerFacade;
    ...
    class SuccessfulCases {
        ...
        public void getDailyWeatherTest() throws Exception {
            ...
            String expectedJson = STR."""
                    [{
                        "temperature":\{expectedOutput.getTemperature()},
                        "time":"\{ TestUtils.localTimeToString(expectedOutput.getTime())}",
                        "state":\{expectedOutput.getState()}
                    }]
                    """;
        ...
        public void getForecastWeatherTest() throws Exception {
            ...
            String expectedJson = STR."""
                    [{
                        "dayTemperature":\{expectedOutput.getDayTemperature()},
                        "nightTemperature":\{expectedOutput.getNightTemperature()},
                        "date":"\{expectedOutput.getDate()}",
                        "state":\{expectedOutput.getState()}
                    }]
                    """;
