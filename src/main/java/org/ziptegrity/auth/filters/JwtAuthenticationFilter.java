package org.ziptegrity.auth.filters;
...
import org.ziptegrity.auth.jwt.JwtParser;
import org.ziptegrity.auth.jwt.JwtValidator;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        logger.debug(token==null?"No jwt in header. Checking cookie":"Jwt provided from header: "+token);
        ...
        logger.debug(token==null?"No jwt in cookie. Fail authenticate.":"Jwt provided from cookie: "+token);
